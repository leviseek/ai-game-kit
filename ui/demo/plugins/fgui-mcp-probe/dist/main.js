...
const import_resource_1 = require("./probes/import-resource");
const copy_handler_1 = require("./probes/copy-handler");
const controller_1 = require("./probes/controller");
const capture_1 = require("./probes/capture");
...
function buildMailboxServer(objsPath) {
    ...
    mailboxServer.register("read_project_settings", handlers_1.handleReadProjectSettings);
    ...
    mailboxServer.register("save_documents", handlers_write_1.handleSaveDocuments);
    mailboxServer.register("import_resource", (0, handlers_write_1.createImportResourceHandler)(mailboxServer));
    mailboxServer.register("add_child", handlers_write_1.handleAddChild);
    mailboxServer.register("delete_child", handlers_write_1.handleDeleteChild);
    mailboxServer.register("set_object_property", handlers_write_1.handleSetObjectProperty);
    mailboxServer.register("add_controller", handlers_write_1.handleAddController);
    mailboxServer.register("update_controller", handlers_write_1.handleUpdateController);
    mailboxServer.register("remove_controller", handlers_write_1.handleRemoveController);
    mailboxServer.register("switch_page", handlers_write_1.handleSwitchPage);
    mailboxServer.register("set_relation", handlers_write_1.handleSetRelation);
    mailboxServer.register("remove_relation", handlers_write_1.handleRemoveRelation);
    mailboxServer.register("create_package", handlers_write_1.handleCreatePackage);
    mailboxServer.register("delete_package", handlers_write_1.handleDeletePackage);
    mailboxServer.register("create_folder", handlers_write_1.handleCreateFolder);
    mailboxServer.register("rename_resource", handlers_write_1.handleRenameResource);
    mailboxServer.register("move_resource", handlers_write_1.handleMoveResource);
    mailboxServer.register("delete_resource", handlers_write_1.handleDeleteResource);
    mailboxServer.register("create_component", handlers_write_1.handleCreateComponent);
    mailboxServer.register("copy_items", handlers_write_1.handleCopyItems);
...
function registerMenu() {
    ...
    probeMenu.AddItem("ImportResource", "import-resource", () => (0, import_resource_1.runImportResourceProbe)());
    probeMenu.AddItem("CopyHandler", "copy-handler", () => (0, copy_handler_1.runCopyHandlerProbe)());
    probeMenu.AddItem("Controller", "controller", () => (0, controller_1.runControllerProbe)());
    probeMenu.AddItem("截图采集", "capture", () => (0, capture_1.runCaptureProbe)());
    ...
    probeMenu.AddItem("运行全部探针", "run-all", () => {
        ...
        (0, import_resource_1.runImportResourceProbe)();
        (0, copy_handler_1.runCopyHandlerProbe)();
        (0, controller_1.runControllerProbe)();
        (0, capture_1.runCaptureProbe)();
