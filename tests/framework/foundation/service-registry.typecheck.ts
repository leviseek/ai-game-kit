import type { ServiceRegistry, ServiceToken } from "../../../assets/framework/core/services/ServiceRegistry";
...
type _TokenTypeIsGenericBound = Expect<Equal<typeof audioToken, ServiceToken<AudioService>>>;
type _TokenDescriptionIsString = Expect<Equal<ServiceToken<AudioService>["description"], string>>;
type _DifferentServiceTypesYieldDistinctTokens = Expect<Equal<Equal<ServiceToken<AudioService>, ServiceToken<LoggerService>>, false>>;
