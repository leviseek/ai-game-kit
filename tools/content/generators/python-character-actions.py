...
def main():
    p=argparse.ArgumentParser(); p.add_argument('--out-dir',required=True); p.add_argument('--character',required=True); p.add_argument('--reference',required=True); p.add_argument('--raw-manifest',required=True); a=p.parse_args()
    ...
    idle=cutout(a.reference); generated={}
