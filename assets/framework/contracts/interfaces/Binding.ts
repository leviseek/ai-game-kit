...
import type { IEnabledBinding } from "./IEnabledBinding";
 ...
 */
export type Binding<VM> = ITextBinding<VM> | IProgressBinding<VM> | IVisibleBinding<VM> | IEnabledBinding<VM> | IPositionBinding<VM> | ICommandBinding<VM>;
