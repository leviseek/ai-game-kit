...
export const AUTO_BATTLE_HEROES: readonly Record<string, unknown>[] = [
    {
        id: "ally-tank",
        name: "auto_battle.heroes.ally-tank.name",
        position: "front",
        baseAttributeId: "tank",
        energyMax: 20,
        skillId: "ally-tank-skill",
        animationId: "warrior-ai",
        weaponType: "dao",
        attackDelivery: "melee",
        basicAttackEffectId: "smash-hit",
    },
    {
        id: "ally-mage",
        name: "auto_battle.heroes.ally-mage.name",
        position: "mid",
        baseAttributeId: "mage",
        energyMax: 20,
        skillId: "ally-mage-skill",
        animationId: "mage-ai",
        weaponType: "crystal-staff",
        attackDelivery: "projectile",
        basicAttackEffectId: "arcane-bolt",
    },
    {
        id: "ally-priest",
        name: "auto_battle.heroes.ally-priest.name",
        position: "back",
        baseAttributeId: "priest",
        energyMax: 20,
        skillId: "ally-priest-skill",
        animationId: "priest",
        weaponType: "golden-warhammer",
        attackDelivery: "projectile",
        basicAttackEffectId: "holy-bolt",
    },
    {
        id: "enemy-tank",
        name: "auto_battle.heroes.enemy-tank.name",
        position: "front",
        baseAttributeId: "skeleton",
        energyMax: 20,
        skillId: "enemy-tank-skill",
        animationId: "warrior-m",
    ...
    {
        id: "enemy-mage",
        name: "auto_battle.heroes.enemy-mage.name",
        position: "mid",
        baseAttributeId: "lich",
        energyMax: 20,
        skillId: "enemy-mage-skill",
        animationId: "lich-ai",
        weaponType: "soul-staff",
        attackDelivery: "projectile",
        basicAttackEffectId: "shadow-bolt",
    },
    {
        id: "enemy-shaman",
        name: "auto_battle.heroes.enemy-shaman.name",
        position: "back",
        baseAttributeId: "shaman",
        energyMax: 20,
        skillId: "enemy-shaman-skill",
        animationId: "warrior-m",
        weaponType: "totem-staff",
        attackDelivery: "projectile",
        basicAttackEffectId: "totem-bolt",
    },
];
...
export const AUTO_BATTLE_UNIT_ANIMATIONS: readonly AutoBattleUnitAnimation[] = [
    ...
    },
    {
        ...
        dir: "auto-battle",
        frameCount: 10,
        frameCountByAnim: { idle: 10, gesture: 10, walk: 8, run: 8, attack: 6, slash: 8, hit: 4, weak: 6, stun: 4, death: 10, skillRaise: 8 },
        frameMsByAnim: { idle: 100, gesture: 100, walk: 100, run: 80, attack: 90, slash: 90, hit: 120, weak: 140, stun: 160, death: 120, skillRaise: 100 },
        prefixByAnim: {
            idle: "mage_ai_idle",
            gesture: "mage_ai_idle",
            walk: "mage_ai_walk",
            run: "mage_ai_run",
            attack: "mage_ai_attack",
            slash: "mage_ai_slash",
            hit: "mage_ai_hit",
            weak: "mage_ai_weak",
            stun: "mage_ai_stun",
            death: "mage_ai_death",
            skillRaise: "mage_ai_skill_raise",
        },
    },
    {
        id: "priest",
        ...
        prefixByAnim: {
            idle: "priest_ai_idle",
            gesture: "priest_ai_idle",
            walk: "priest_ai_walk",
            run: "priest_ai_run",
            attack: "priest_ai_attack",
            slash: "priest_ai_slash",
            hit: "priest_ai_hit",
            weak: "priest_ai_weak",
            stun: "priest_ai_stun",
            death: "priest_ai_death",
            skillRaise: "priest_ai_skill_raise",
        },
    },
    {
        id: "lich-ai",
        ...
        prefixByAnim: {
            idle: "lich_ai_idle",
            gesture: "lich_ai_idle",
            walk: "lich_ai_walk",
            run: "lich_ai_run",
            attack: "lich_ai_attack",
            slash: "lich_ai_slash",
            hit: "lich_ai_hit",
            weak: "lich_ai_weak",
            stun: "lich_ai_stun",
            death: "lich_ai_death",
            skillRaise: "lich_ai_skill_raise",
        },
    },
];
...
export const AUTO_BATTLE_SKILL_EFFECTS: readonly AutoBattleSkillEffectDef[] = [
    ...
    { id: "arcane-bolt", kind: "arcane-bolt" },
    { id: "shadow-bolt", kind: "shadow-bolt" },
    { id: "holy-bolt", kind: "holy-bolt" },
    { id: "totem-bolt", kind: "totem-bolt" },
];
